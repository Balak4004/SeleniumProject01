...
class DashboardPage:
    ...
    def get_user_logged_in(self):
        return self.driver.find_element(*self.locators['user_logged_in'])

    def user_logged_in_text(self,timeout=90):
        wait = WebDriverWait(self.driver,timeout)
        wait.until(EC.visibility_of_element_located(self.locators['user_logged_in']))
